...
## Custom Modification
1. export query mutation and responses
2. add Query or Mutation suffix for clarity
3. change type generation errors to non-fatal warning until they are fixed
---
